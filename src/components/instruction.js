...
const Instruction = () => {
  ...
  return (
    <div className="flex h-full min-h-screen items-start justify-center home-bg bg-cover flex-col px-10 py-16 sm:px-40">
      <Link
        to="/"
      ...
      <h2 className="text-white text-2xl md:text-5xl mb-5 mt-10 text-left font-bold">GamePlay</h2>
      <ul>
